        ...
        try {
            ...
            if (userAccount) {
                ...
                if (currentUserData && currentUserData.emailVerification) {
                    ...
                    setMessage("Account created! Please check your email and verify your account before logging in.");
                }
            }
        } catch (error) {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10">
                ...
                {message && <p className="text-green-600 mt-8 text-center">{message}</p>} {/* Display success message */}
